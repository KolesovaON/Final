...
Сценарий: Проверка печатной формы
        ...
        Дано Табличный документ "SpreadsheetDocument" равен макету "МакетРасходаТовара" по шаблону    
        И в табличном документе "SpreadsheetDocument" ячейка с адресом "R7C3" равна "2 725*" по шаблону
